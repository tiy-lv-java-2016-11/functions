...
1. Use the files `items.js` and `index.html` in this repo. 
...
> Make sure the output matches the answers below each question. Make sure to comment your code as you walk through your process.
